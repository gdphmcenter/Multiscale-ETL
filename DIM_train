...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='cnn_features_1d', help='the name of the model') ## Serial_LCN Parral_LCNconcate  Parrral_LCNadd   LSTM  Serial_CLN
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='./23/huang/620', help='the directory to save the model') #'./23/datafusion/M/dianci'
    ...
    parser.add_argument('--middle_epoch', type=int, default=25, help='middle number of epoch')
    parser.add_argument('--max_epoch', type=int, default=60, help='max number of epoch')
    parser.add_argument('--print_step', type=int, default=60, help='the interval of log training information日志训练信息的间隔')
